...
|--------------------------------------------------------------------------
|
| As seguintes linhas de idioma são usadas para trocar nossos marcadores de posição de atributos
| por algo mais amigável, como "Endereço de E-mail" em vez de "email". Isso simplesmente nos ajuda a tornar nossa mensagem mais expressiva.
|
*/
