...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são as linhas padrão que correspondem a razões
    | dadas pelo password broker para uma tentativa de atualização de senha
    | ter falhado, como por um token inválido ou uma nova senha inválida.
    |
    */
